...
public class ManeyManagementController {
	...
	public String home(@AuthenticationPrincipal User user, Model model) {
		...
		// 今月の入金合計額
		model.addAttribute("totalNowMonthInput", inputService.checkTotalNowMonthInput());
		...
		// 今月の支出合計額
		model.addAttribute("totalNowMonthOutput", outputService.checkTotalNowMonthOutput());
